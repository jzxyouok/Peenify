...
class CategoriesController extends Controller
{
    ...
    {
        $filename = (is_null($request->file('cover'))) ? null : upload_image('categories', $request->file('cover'));
    ...
    {
        $this->categoryService->update($id, update_image($request, 'cover', 'categories'));
