<div class="form-group">
    ...
    <input type="text" name="options[origin_name]" class="form-control">
</div>

<div class="form-group">
    <label for="name">集數 * 26</label>
...
<div class="form-group">
    <label for="name">國家 * 台灣, 美國</label>
    <input type="text" name="options[country]" class="form-control">
</div>